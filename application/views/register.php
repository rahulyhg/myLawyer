                ...
                <div class="panel-body">
                    ...
                    echo form_dropdown('provincial-area', $options, 'western',$attribute);
                        ...
                        $options = array(
                            ...
                            'Kandy'         => 'Kandy',
                            'Kalmunai'         => 'Kalmunai',
                            'Kaduwela-Combined-Court'         => 'Kaduwela Combined Court  ',
                            'Kabithigollewa-Magistrate-Court '         => 'Kabithigollewa Magistrate Court  ',
                            'Jaffna-'         => 'Jaffna  ',
                            'Horana-Combined-Court '         => 'Horana Combined Court  ',
                            'Homagama-Combined-Court '         => 'Homagama Combined Court  ',
                            'Hambanthota'         => 'Hambanthota  ',
                            'Gampola-Combined-Court '         => 'Gampola Combined Court  ',
                            'Gampaha'         => 'Gampaha  ',
                            'Galgamuwa-Magistrate-Court '         => 'Galgamuwa Magistrate Court  ',
                            'Embilipitiya'         => 'Embilipitiya  ',
                            'Elpitiya'         => 'Elpitiya  ',
                            'Dambulla-Magistrate-Court '         => 'Dambulla Magistrate Court  ',
                            'Colombo'         => 'Colombo  ',
                            'Chilaw'         => 'Chilaw  ',
                            'Chavakachcheri-Combined-Court '         => 'Chavakachcheri Combined Court  ',
                            'Bibile-Magistrate-Court-(Civil Appeal) '         => 'Bibile Magistrate Court (Civil Appeal)  ',
                            'Batticaloa'         => 'Batticaloa  ',
                            'Bandarawela'         => 'Bandarawela  ',
                            'Bambalapitiya-Jevencile-Court '         => 'Bambalapitiya Jevencile Court  ',
                            'Balapitiya'         => 'Balapitiya  ',
                            'Balangoda-Combined-Court '         => 'Balangoda Combined Court  ',
                            'Badulla'         => 'Badulla  ',
                            'Baddegama-Magistrate-Court '         => 'Baddegama Magistrate Court  ',
                            'Avissawella'         => 'Avissawella  ',
                            'Attanagalla-Magistrate-Court-(Combined-Court) '         => 'Attanagalla Magistrate Court (Combined Court)  ',
                            'Anuradhapura'         => 'Anuradhapura  ',
                            'Anamaduwa-Magistrate-Court-(Civil-Appeal) '         => 'Anamaduwa Magistrate Court (Civil Appeal)  ',
                            'Ampara'         => 'Ampara  ',
                            'Akkaraipattu-District-Court-(Combind Court) '         => 'Akkaraipattu District Court (Combind Court)  ',
